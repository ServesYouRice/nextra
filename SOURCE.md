...
The packaged `SBOM.cdx.json` records the server runtime dependency graph. Source
for third-party components is available from the upstream projects listed in the
SBOM and `THIRD_PARTY_NOTICES.md`.
