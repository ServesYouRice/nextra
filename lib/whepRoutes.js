...
function getRequestIp(req) {
    // Trust X-Forwarded-For only if the server is configured for it
    if (config.TRUST_X_FORWARDED_HEADERS || config.TRUST_PROXY) {
 ...
 */
function createWhepRouter(mediasoupRouter) {
    const router = Router();
