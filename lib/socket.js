...
async function startFallbackRelay(room, mediasoupRouter, io) {
    ...
    try {
        ...
        relay.on('init', (data) => {
            const expectedVideoTag = room.fallbackCodec === 'av1' ? 'av01' : 'avc1';
            if (!initSegmentHasCodec(data.initSegment, expectedVideoTag)) {
                ...
                console.warn(`[Fallback] Init segment for room ${room.code} is missing ${expectedVideoTag}; requesting keyframe and restarting relay`);
