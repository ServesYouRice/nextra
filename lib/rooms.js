...
function createRoom(hostSocketId, options = {}) {
    ...
    const room = {
        ...
        fallbackSequence: 0,
        fallbackWorker: null,
        // Synchronous latch: true from the moment startFallbackRelay claims the slot
        // until it finishes, so concurrent callers can't spawn a duplicate pipeline
        // during its (many-await) startup window.
