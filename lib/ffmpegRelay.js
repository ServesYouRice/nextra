...
class FFmpegRelay extends EventEmitter {
     ...
     * AAC. Both inputs use wallclock timestamps so they stay roughly in sync.
     */
    _buildArgs(sdpPath) {
        ...
        if (this.hasAudio) {
            ...
            // itsoffset delays the audio to compensate for the relay starting audio
            // a moment after the video pipe, keeping A/V in sync.
