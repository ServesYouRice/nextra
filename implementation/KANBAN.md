...
- [ ] [T02 Clean build and readiness](T02-build-readiness.md) — after T01.
- [ ] [T03 Delayed relay generation](T03-relay-generation.md) — after T01.
- [ ] [T04 Truthful restart states](T04-restart-states.md) — after T01.
- [ ] [T06 Backend correctness](T06-backend-correctness.md) — after T01 and T05 helpers.
- [ ] [T07 Media capability truth](T07-media-capabilities.md) — after T01.
- [ ] [T11 Small polish and extraction](T11-polish.md) — after T01–T10.

## Blocked

- [ ] [T05 Operator and WHIP boundary](T05-operator-boundary.md) — needs D01.
- [ ] [T08 UI, accessibility, support](T08-ui-accessibility.md) — needs D05, T03, T04, T07.
- [ ] [T09 Security operations](T09-security-operations.md) — needs D02 and T05.
- [ ] [T10 Release evidence](T10-release-evidence.md) — needs T01–T09 and D03–D05.

## User needs to decide / provide

| ID | Needed | Recommended default | Unblocks |
| --- | --- | --- | --- |
| D01 | Who may host remotely and whether public WHIP is enabled | Loopback hosts by default; remote hosting requires an operator token; public WHIP off | T05 |
